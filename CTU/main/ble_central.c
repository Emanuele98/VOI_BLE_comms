                ...
                void *arg)
{
    ...
    {
        case 1:
            //ESP_LOGW(TAG, "first pad - %d - %d" , last_pad1, low_power_pads[0]);
            ...
            break;
        case 2:
            //ESP_LOGW(TAG, "second pad - %d - %d" , last_pad2, low_power_pads[1]);
            ...
            break;
        case 3:
            //ESP_LOGW(TAG, "third pad - %d - %d" , last_pad3, low_power_pads[2]);
